...
urlpatterns = [
    ...
    path('dashboard/', views.dashboard, name = 'events-dashboard'),
    path('<int:pk>', views.event_detail, name = 'events-detail'),
    path('category/<int:pk>/', views.events_category, name = 'events-category'),
